...
def get_fountains_by_area(
    ...
    """
    if params.area:
        osm_data = osm_api.get_fountains_by_area(params.area, params.timeout)
    else:
        osm_data = osm_api.get_fountains(params.timeout)
...
def get_fountains_by_radius(
    ...
    - JSON with fountains data either in raw OSM format or processed format.
    """
    osm_data = osm_api.get_fountains_by_radius(params.lat, params.long, params.radius, params.timeout)
...
def get_fountains_by_bbox(
    ...
    - JSON with fountains data either in raw OSM format or processed format.
    """
    osm_data = osm_api.get_fountains_by_bbox(params.south_lat, params.west_long, params.north_lat, params.east_long, params.timeout)
